...
/**
 * Adapter d'entree REST qui enchaine deux use cases : composer le plan, puis
 * estimer son cout. Ce n'est pas de la logique metier — juste l'ordre dans
 * lequel appeler les ports pour repondre a une seule requete HTTP ; la
 * meme distinction domain/application que partout ailleurs dans ce projet,
 * appliquee ici a la frontiere web plutot qu'a un service applicatif.
 */
@RestController
